...
import ImportGroupsSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: ImportGroupsItem[]
      }
   

    export default function SearchImportGroups(
        props: {
          onItemClick? : (item:ImportGroupsItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ImportGroupsSmallCard item={item} 
