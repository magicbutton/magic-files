...
import {EventsSchema} from "../applogic/model";
...
export function EventsForm(props : {events: EventsItem,editmode:"create"|"update"}) {
    const {events,editmode} = props;
    function onSubmit(data: z.infer<typeof EventsSchema>) {
        toast({
