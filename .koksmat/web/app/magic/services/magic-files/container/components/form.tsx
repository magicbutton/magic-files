...
import {ContainerSchema} from "../applogic/model";
...
export function ContainerForm(props : {container: ContainerItem,editmode:"create"|"update"}) {
    const {container,editmode} = props;
