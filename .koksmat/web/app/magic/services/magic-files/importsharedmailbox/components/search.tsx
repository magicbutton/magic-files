...
import ImportSharedMailboxSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: ImportSharedMailboxItem[]
      }
   

    export default function SearchImportSharedMailbox(
        props: {
          onItemClick? : (item:ImportSharedMailboxItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ImportSharedMailboxSmallCard item={item} 
