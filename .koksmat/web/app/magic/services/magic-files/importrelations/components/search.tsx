...
import ImportRelationsSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: ImportRelationsItem[]
      }
   

    export default function SearchImportRelations(
        props: {
          onItemClick? : (item:ImportRelationsItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ImportRelationsSmallCard item={item} 
