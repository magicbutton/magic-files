...
import PlatformCategorySmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchPlatformCategory(
        props: {
          onItemClick? : (item:PlatformCategoryItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <PlatformCategorySmallCard item={item} 
