...
import ImportSharePointSiteSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: ImportSharePointSiteItem[]
      }
   

    export default function SearchImportSharePointSite(
        props: {
          onItemClick? : (item:ImportSharePointSiteItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ImportSharePointSiteSmallCard item={item} 
